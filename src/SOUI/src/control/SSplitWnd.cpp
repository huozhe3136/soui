...
#define DEF_SEPSIZE    5
    ...
    SSplitPane::SSplitPane():m_nSizeIdeal(20), m_nSizeMin(0), m_nSizeMax(10000), m_nPriority(0)
    {
    ...
    {
        if ((int)iPane < 0 || iPane >= m_lstPane.GetCount()) return FALSE;
