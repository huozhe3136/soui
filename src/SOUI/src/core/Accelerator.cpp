...
namespace SOUI
{
    ...
    CAccelerator::CAccelerator(UINT vKey,bool bCtrl,bool bAlt,bool bShift):m_wModifier(0), m_wVK(vKey)
    {
    ...
    CAccelerator::CAccelerator(DWORD dwAccel):m_wModifier(HIWORD(dwAccel)), m_wVK(LOWORD(dwAccel))
    {
