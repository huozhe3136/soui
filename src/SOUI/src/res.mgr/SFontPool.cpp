...
{
	this->dwStyle = other.dwStyle;
	this->strFaceName= other.strFaceName;
	this->strPropEx = other.strPropEx;
}
...
IFontPtr SFontPool::GetFont(FONTSTYLE style, const SStringW & fontFaceName,pugi::xml_node xmlExProp)
{
	...
	FontInfo info;
	info.dwStyle = style.dwStyle;
	info.strFaceName = strFace;
	info.strPropEx = strXmlProp;
