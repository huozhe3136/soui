...
///////////////////////////////////////////////////////////////////////////
// IOleContainer
HRESULT SAxContainer::EnumObjects(DWORD /*grfFlags*/, IEnumUnknown** /*ppenum*/)
{
	ATLTRACENOTIMPL(_T("ActiveXContainerImpl::EnumObjects\n"));
}

HRESULT SAxContainer::LockContainer(BOOL /*fLock*/)
{
	ATLTRACENOTIMPL(_T("ActiveXContainerImpl::LockContainer\n"));
}

// IOleContainer::IParseDisplayName
HRESULT SAxContainer::ParseDisplayName(IBindCtx* /*pbc*/, LPOLESTR /*pszDisplayName*/,
