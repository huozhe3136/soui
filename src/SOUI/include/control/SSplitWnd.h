...
class SOUI_EXP SSplitPane : public SWindow
{
    ...
    SOUI_CLASS_NAME_DECL(SSplitPane, L"pane")
public:
...
class SOUI_EXP SSplitWnd :
    public SWindow
{
    SOUI_CLASS_NAME_DECL(SSplitWnd, L"splitwnd")
...
{
    SOUI_CLASS_NAME_DECL(SSplitWnd_Col, L"splitcol")
public:
	SSplitWnd_Col();
};
...
{
    SOUI_CLASS_NAME_DECL(SSplitWnd_Row, L"splitrow")
public:
	SSplitWnd_Row();
};
