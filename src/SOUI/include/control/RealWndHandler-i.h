...
namespace SOUI
{
    ...
    */
    struct IRealWndHandler : public IObjRef
    {
        ...
        * Describe  窗口创建
        */    
        virtual HWND OnRealWndCreate(SRealWnd *pRealWnd) = 0;
        ...
        * Describe  销毁窗口
        */
        virtual void OnRealWndDestroy(SRealWnd *pRealWnd) = 0;
        ...
        * Describe  初始化窗口
        */
		virtual BOOL OnRealWndInit(SRealWnd *pRealWnd)=0;
        ...
        */
		virtual BOOL OnRealWndSize(SRealWnd *pRealWnd) = 0;
		...
		* Describe  调整窗口大小
		*/
		virtual BOOL OnRealWndPosition(SRealWnd *pRealWnd, const CRect &rcWnd) = 0;
    };
