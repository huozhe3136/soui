...
static const int KID_Year_Begin           = 2000;
    ...
    bool SCalendar2::OnMonthClick(EventArgs *pArg)
    {
    ...
    bool SCalendar2::OnBtnNextMonth(EventArgs *pArg)
    {
    ...
    bool SCalendar2::OnBtnPrevMonth(EventArgs *pArg)
    {
        int iYear = m_pCalendar->GetYear();
        int iMonth = m_pCalendar->GetMonth();
        iMonth --;
    ...
    bool SCalendar2::OnBtnNext10Year(EventArgs *pArg)
    {
        m_iBeginYear += 10;
        initYearButtons();
        return true;
    ...
    bool SCalendar2::OnBtnPrev10Year(EventArgs *pArg)
    {
        m_iBeginYear -= 10;
        initYearButtons();
        return true;
    ...
    bool SCalendar2::OnBtnPickMonthFinish(EventArgs *pArg)
    {
    ...
    bool SCalendar2::OnBtnPickMonthCancel(EventArgs *pArg)
    {
        m_pMonthPickerPanel->SetVisible(FALSE,TRUE);
        m_pCalenderPanel->SetVisible(TRUE);
        return true;
    ...
    bool SCalendar2::OnSetCalendarDate(EventArgs *pArg)
    {
        SStringT strMonth = SCalendarCore::FormatYear(m_pCalendar->GetYear()) +_T("|")+ SCalendarCore::FormatMonth(m_pCalendar->GetMonth());
        m_pTxtMonth->SetWindowText(strMonth);
        return true;
